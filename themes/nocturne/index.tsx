    ...
    <div className={styles.page}>
      ...
      <article className={styles.article}>
        ...
        <nav className={styles.pager}>
          ...
          {next ? <a className={styles.pagerLink} href={reviewHref(t, next.slug)} style={{ textAlign: "right" }}>Next →<span>{next.title}</span></a> : <span />}
        </nav>
      </article>
      <Footer />
    </div>
...
const theme: ThemeModule = {
  meta: { key: "nocturne", name: "Nocturne", blurb: "Warm charcoal, gold and Newsreader — the museum after dark." },
  Home,
  ReviewPage,
  About,
  Submit,
